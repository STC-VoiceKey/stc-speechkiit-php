...
class Audio implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Audio';
     ...
     * Sets data
     *
     * @param string $data Audio in base64 for diarization
     *
     * @return $this
     */
     ...
     * Sets mime
     *
     * @param string $mime Mime type of audio. Possible value: audio/alaw, audio/mulaw, audio/s16be, audio/wav
     *
     * @return $this
     */
